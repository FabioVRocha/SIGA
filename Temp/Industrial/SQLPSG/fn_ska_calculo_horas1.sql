-- Function: fn_ska_calculo_horas1(numeric, numeric, character, numeric, date)

-- DROP FUNCTION fn_ska_calculo_horas1(numeric, numeric, character, numeric, date);

CREATE OR REPLACE FUNCTION fn_ska_calculo_horas1(primeiro_valor numeric, segundo_valor numeric, operacao character, retorno numeric, p_datainicio date)
  RETURNS date AS
$BODY$
DECLARE
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION fn_ska_calculo_horas1(numeric, numeric, character, numeric, date) SET search_path=public, pg_temp;

ALTER FUNCTION fn_ska_calculo_horas1(numeric, numeric, character, numeric, date)
  OWNER TO postgres;
