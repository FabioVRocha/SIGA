-- Function: fn_alterou_respror()

-- DROP FUNCTION fn_alterou_respror();

CREATE OR REPLACE FUNCTION fn_alterou_respror()
  RETURNS trigger AS
$BODY$
declare
	v_data date;
...
BEGIN	
	if TG_OP <> 'DELETE' then		
		...
		NEW.RPRDTALT = v_data;
		NEW.RPRHRALT = v_horario;
		NEW.RPRUSALT = v_usuario;
	end if;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION fn_alterou_respror() SET search_path=public, pg_temp;

ALTER FUNCTION fn_alterou_respror()
  OWNER TO postgres;