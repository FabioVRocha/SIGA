-- Function: fn_alterou_ordem()

-- DROP FUNCTION fn_alterou_ordem();

CREATE OR REPLACE FUNCTION fn_alterou_ordem()
  RETURNS trigger AS
$BODY$
declare
	v_data date;
...
BEGIN	
	if TG_OP <> 'DELETE' then		
		...
		NEW.ORDDTALT = v_data;
		NEW.ORDHRALT = v_horario;
		NEW.ORDUSALT = v_usuario;
	end if;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION fn_alterou_ordem() SET search_path=public, pg_temp;

ALTER FUNCTION fn_alterou_ordem()
  OWNER TO postgres;