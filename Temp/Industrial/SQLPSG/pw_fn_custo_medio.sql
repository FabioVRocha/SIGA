-- Function: pw_fn_custo_medio(character, numeric, date)

-- DROP FUNCTION pw_fn_custo_medio(character, numeric, date);

CREATE OR REPLACE FUNCTION pw_fn_custo_medio(pproduto character, pdeposito numeric, pdata date)
  RETURNS numeric AS
$BODY$
DECLARE
	vdata date;
...
$BODY$
  ...
  COST 100;
ALTER FUNCTION pw_fn_custo_medio(character, numeric, date) SET search_path=public, pg_temp;

ALTER FUNCTION pw_fn_custo_medio(character, numeric, date)
  OWNER TO postgres;
