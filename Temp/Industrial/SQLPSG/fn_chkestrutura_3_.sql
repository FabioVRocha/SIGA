drop function if exists fn_chkestrutura_3(poriginal CHARACTER, ppercorridos text[], plerestrutura character, precursao integer, pnivel integer, pcaminho text);

CREATE OR REPLACE FUNCTION fn_chkestrutura_3(poriginal CHARACTER, ppercorridos text[], plerestrutura character, precursao integer, pnivel integer, pcaminho text)
  RETURNS text[] AS
$BODY$
DECLARE
